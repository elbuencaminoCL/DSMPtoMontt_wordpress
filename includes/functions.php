...
function wpse_setup_theme() {
    ...
    if ( function_exists( 'add_image_size' ) ) { 
        ...
        add_image_size( 'news-home', 230, 150, array( 'center', 'center'));
...
function my_custom_login_logo() {
    echo '<style type="text/css">
        ...
        h1 a { background-image:url('.get_bloginfo('template_directory').'/imag/logo/logo_cdsm_admin.png) !important; background-size:320px 67px !important; width:320px !important; height:67px !important;}
    </style>';
}
    ...
    if(!empty($home_pages)){
        ...
        foreach($home_pages as $hpages){
            ...
            if($hpages->menu_order >= 0){
                echo '<div class="'.$pos.' col-md-4 col-xs-12">';
                    echo '<div class="row">';
                        echo '<div class="col-md-12 col-sm-4 col-xs-5">';
                            echo '<div class="row">';
                                echo get_the_post_thumbnail($hpages->ID, 'child', array('class' => 'img-responsive'));
                            echo '</div>';
                        echo '</div>';
                        echo '<div class="col-md-12 col-sm-8 col-xs-7">';
                            echo '<h4>'.$hpages->post_title.'</h4>';
    ...
    register_post_type( 'actividades',
        array(
            'labels' => array(
                ...
                'add_new' => __('Agregar Taller'),
                'add_new_item' => __('Agregar nuevo Taller'),
                'edit_item' => __('Editar Taller'),
                'new_item' => __('Nuevo Taller'),
                'all_items' => __('Todos los Talleres'),
                'view_item' => __('Ver Talleres'),
                'search_items' => __('Buscar Talleres')
            ),
            'public' => true,
            'has_archive' => true,
            'rewrite' => array('slug' => 'ver-talleres', 'hierarchical' => true),
            'hierarchical' => true,
            'show_ui' => true,
            'query_var' => true,
...
//=================================================================== WORDPRESS WIDGETS// 
    function cdsm_widgets_init() {
        register_sidebar(array(
            'name' => __('Sidebar Header Left', 'cdsm'),
            'description' => __('Sidebar header left', 'cdsm'),
            'id' => 'sidebar-left',
            'before_title' => '<h2>',
            'after_title' => '</h2>',
            'before_widget' => '',
        ...
        register_sidebar(array(
            'name' => __('Sidebar Header Right', 'cdsm'),
            'description' => __('Sidebar header right', 'cdsm'),
            'id' => 'sidebar-right',
            'before_title' => '<h2>',
            'after_title' => '</h2>',
            'before_widget' => '',
        ...
        register_sidebar(array(
            'name' => __('Sidebar Interior', 'cdsm'),
            'description' => __('Sidebar Interior', 'cdsm'),
            'id' => 'sidebar-interior',
            'before_title' => '<h2>',
            'after_title' => '</h2>',
            'before_widget' => '',
    ...
    add_action('widgets_init', 'cdsm_widgets_init');
//
?>